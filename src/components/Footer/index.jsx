    ...
    <FooterContainer id="Contact">
      <FooterWrap>
        <PersonalInfoWrap>
          ...
          <CompanyEmail>Hello@focal.mail.com</CompanyEmail>
          <CompanyEmail>028-231-311-095</CompanyEmail>
        </PersonalInfoWrap>
        <FooterLinksContainer>
          {navlinks.map((link) => (
            <FooterLinksWrap>
              <FooterLinksTitleWrap>
                <FooterLinksTitle>{link.title}</FooterLinksTitle>
              </FooterLinksTitleWrap>
              <FooterLinks>
                <CompanyEmail op={true} href="#">
                  {link.link1}
                </CompanyEmail>
                <CompanyEmail op={true} href="#">
                  {link.link2}
